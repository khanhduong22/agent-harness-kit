...
2. **Mermaid Sequence Flow Diagram** — Every non-trivial proposal or spec MUST include a valid `mermaid` sequence diagram visualizing the interaction flow between Client, API Controllers, Services, and Database.
